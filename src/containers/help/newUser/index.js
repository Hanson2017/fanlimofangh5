            ...
            <div className='newUserContainer'>
                ...
                <div className='mt30' ref='newUser'>
                    ...
                    <div className='box'>
                        <div className='content'>
                            <p>先说2个关键点：</p>
                            <p>① 首次出借活动<span className='red'>必须从直达链接跳转到平台进行注册，必须！ </span><strong>（多次出借不需要）</strong>；</p>
                            <p>② 严格按照页面里描述的出借规则进行出借，完事了记得在页面下方回帖，留下正确信息以及支付宝帐号，这样才能拿到返利。</p>
                            <p className='mt10'><img src={require('../../../assets/images/newser/pp.png')} /></p>
                            <div className='bdr'>
                                <p>下面以桔子理财活动为例来讲解具体操作过程。</p>
                            </div>
                ...
                <div className='box mt20'>
                    <div className='content'>
                        ...
                        <h5 className='h5'>一、首先从返利魔方APP首页或项目列表页找到您感兴趣的活动，如下图所示：</h5>
         
                        <p className='mt10'><img src={require('../../../assets/images/newser/p1.png')} /></p>
                        <p>（在上图您可以看到该平台的风控评分和风险等级等信息。）</p>
                ...
                <div className='box mt20'>
                    <div className='content'>
                        ...
                        <h5 className='h5'>二、如果您对该活动有兴趣，</h5>
                        ...
                        }}>点开查看详情</div>
                        {
                            this.state.isHidden[0] ?
                                ...
                                <div className='mt20'>
                                    <p><b>1代表</b> 方案序号</p>
                                    <p><b>2代表</b> 每个方案出借是出借多长时间的项目；（出借项目的期限可以比方案要求的更长，但不能短于方案要求的期限。）</p>
                                    <p><b>3代表</b> 出借哪一类项目；</p>
                                    <p><b>4代表</b> 需要充值多少；（可以充值更多，也可以分次充值，但不能少于方案要求的金额。）</p>
                                    <p><b>5代表</b> 返利魔方给多少返利；（<span className='red'>这里就是通过魔方出借可以多得到的钱了</span>）</p>
                                    <p><b>6代表</b> 总回报是多少；</p>
                                    <p><b>7代表</b> 查看此方案更多详细资料</p>
                                </div>
                        }
                        <div className='bdr'>
                            <h6 className='h6'>B、点击某个方案下面的“点击查看详情”按钮，可以很清楚得看到出借方案的信息。</h6>
                            <p>如下图所示：</p>
                            ...
                            }}>点开查看详情</div>
                            {
                                this.state.isHidden[1] ?
                                    ...
                                    :
                                    <div className='mt20'>
                                        <p><b>1代表</b> 出借回报换算成年化收益率是多少</p>
                                        <p><b>2代表</b> 假设平台发生意外导致拿不回本金，返利魔方对本金的赔付比例。（示例这里写的是0）</p>
                                        <p><b>3代表</b> 魔方赔付的保障期限，比如您2007年1月1日参加活动进行出借，假设保障期是35天，那么在2007年2月4日之前如果因网贷平台原因导致无法拿回本金，则魔方会对该笔出借进行赔付。赔付兑现时间为从返利魔方确认该平台无法兑付起，1个月内按照赔付率进行赔付。（该示例中：如果在2月4日之前网贷平台状态为正常，但用户自己未提现，则魔方不予赔付）。</p>
                                        <p><b>4代表</b> 出借流程，这里是对出借过程做详细说明，请根据出借流程指引进行出借。 （出借流程说明一般分为几部分内容，
                ...
                <div className='box mt20'>
                    <div className='content'>
                        <h5 className='h5'>三 、出借完记得在活动页面回帖</h5>
                        <p className='mt10'><img src={require('../../../assets/images/newser/p3.png')} /></p>
                        <p>如上图所示，出借完记得在页面下面跟帖留下出借相关信息，包括您的支付宝帐号。</p>
                        <p>必须有支付宝帐号，返利魔方工作人员才能把返利支付给您。</p>
